...
class BingheBase(object):
    def __init__(self):
        self.host = current_app.config.get('BINGHE_HOST')

    def get_headers(self):
        base64_secret = base64.b64encode(current_app.config.get('BINGHE_SECRET').encode("utf-8")).decode("utf-8")
        return {
