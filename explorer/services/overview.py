...
from base.third.binghe_sdk import BingheBase
...
class OverviewDayService(object):
    ...
    def sync_overview_day_rrm(cls, date_str=None):
        ...
        # 获取昨日信息，没有则取前天
        yesterday_info = BingheBase().get_overview_stat(date=date_str)
        ...
        OverviewDay.objects(date=date_str).update(
            rrm_avg_pledge=Decimal128(avg_pledge * _d(10 ** 18)),
            rrm_avg_reward=Decimal128(unit_t_reward * _d(10 ** 18)),
            rrm_create_gas_32=Decimal128(create_gas_32 * _d(10 ** 18)),
            rrm_create_gas_64=Decimal128(create_gas_64 * _d(10 ** 18)),
            rrm_keep_gas_32=Decimal128(keep_gas_32 * _d(10 ** 18)),
            rrm_keep_gas_64=Decimal128(keep_gas_64 * _d(10 ** 18))
        )
