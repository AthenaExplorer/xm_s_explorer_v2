...
def get_miner_health_report_24h_by_no():
    ...
    if miner_day_stat:
        ...
        result["worker_balance"] = WalletsService.get_is_all_wallet(miner.worker_id).value
        result["poster_balance"] = WalletsService.get_is_all_wallet(miner.post_id).value
...
def get_wallet_address_estimated_service_day():
    ...
    worker_balance = WalletsService.get_is_all_wallet(miner.get("worker_id")).value
    post_balance = WalletsService.get_is_all_wallet(miner.get("post_id")).value
